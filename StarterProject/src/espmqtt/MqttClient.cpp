...
void MqttClient2::set(String serverHost, int serverPort,
...
{
	MQTT_Disconnect(&(this->mqttClient));
}
...
bool MqttClient2::publishWithQoS(char* topic, char* message, int length,
		int qoS, bool retained)
{
	int res = MQTT_Publish(&(this->mqttClient), topic, message, length,
