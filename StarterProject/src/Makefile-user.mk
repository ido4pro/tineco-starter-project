...
MODULES = app hw lib espmqtt controller webRoutes
...
## esptool2 path
#ESPTOOL2        ?= ~/Dropbox/BitBucket/Soft_Capteur/Radiator_0_0_0/tools/esptool2
# ESPTOOL2        ?= ~/Dropbox/BitBucket/tools/esptool2
